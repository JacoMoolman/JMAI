...
simulators = {
    'AUDUSD': RealTimeSimulator(f'{data_dir}/AUDUSD_C.csv', '2001.01.01 00:00'),
    'EURUSD': RealTimeSimulator(f'{data_dir}/EURUSD_C.csv', '2001.01.01 00:00'),
    'GBPUSD': RealTimeSimulator(f'{data_dir}/GBPUSD_C.csv', '2001.01.01 00:00'),
    'USDJPY': RealTimeSimulator(f'{data_dir}/USDJPY_C.csv', '2001.01.01 00:00')
}
